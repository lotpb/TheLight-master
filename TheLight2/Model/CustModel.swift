...
struct CustModel {
    ...
    init(dictionary: [String: Any]) {
        ...
        self.custId = dictionary["custId"] as? String ?? ""
        ...
        self.quan = dictionary["quan"] as? NSNumber ?? 0
        self.zip = dictionary["zip"] as? NSNumber ?? 0
        self.custNo = dictionary["custNo"] as? NSNumber ?? 0
        ...
        self.start = Date(timeIntervalSince1970: dictionary["start"] as? Double ?? 0)
        self.completion = Date(timeIntervalSince1970: dictionary["completion"] as? Double ?? 0)
    }
}
